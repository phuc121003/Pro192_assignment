...
public class MenuRoom {
    ...
    public void addNewRoom() {
        ...
        Room room = new Room(roomID, roomType, status, price);
    ...
    private void searchRoom(Menu<String> mainMenu) {
        String[] searchMenuOptions = { "Find by RoomID", "Find by RoomType", "Find by RoomStatus", "Find by RoomPrice",
                "Return Menu" };
        Menu<String> searchMenu = new Menu<String>("Room Searching", searchMenuOptions) {
            @Override
            public void excute(String selected) {
                switch (selected) {
                    case "1":
                        searchRoomByID();
                        break;
    ...
    private void updateRoom(Menu<String> mainMenu) {
        ...
        String[] searchMenuOptions = { "Update RoomID", "Update RoomType", "Update Status", "Update Price", "Return Menu" };
        Menu<String> searchMenu = new Menu<String>("Customer Searching", searchMenuOptions) {
            @Override
            public void excute(String selected) {
    ...
    public void run() {
        ...
        String[] mainMenuOptions = { "Display all room", "Add new room", "Search room",
                "Delete room by ID", "Update room", "Exit!" };
        Menu<String> mainMenu = new Menu<String>("Company Management System", mainMenuOptions) {
            @Override
            public void excute(String selected) {
                switch (selected) {
                    case "1":
