...
// public class RoomManagement2 extends Menu<String>{
// private ArrayList<Room> rooms = new ArrayList<>();
// protected Scanner sc = new Scanner(System.in);
// static String[] mainMenuOptions = { "Display rented room", "Add new room",
// "Search room", "Delete room by ID", "Update room", "Exit!" };
// public RoomManagement2() {
...
// case "2":
// for(Room room : rooms) {
// if(room.getRoomType().equalsIgnoreCase("couple room") &&
// room.isIsRented()==false) {
// room.setIsRented(true);
// break;
// }
// }
...
// // if (data.length == 4) {
// // Room room = new Room(data[0], data[1], Float.parseFloat(data[2]),
...
// // for (Room room : rooms) {
// // bw.write(room.getRoomID() + ", " + room.getRoomType() +", " +
// room.getPrice() + ", " + room.isIsRented());
// // bw.newLine();
// // }
// // bw.close();
...
// Collections.sort(rooms, (Room o1, Room o2) ->
// o1.getRoomID().compareTo(o2.getRoomID()));
// }
